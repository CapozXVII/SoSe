 ...
 *         &lt;element name="seatsNumber" type="{http://www.w3.org/2001/XMLSchema}int" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class HallType {
    ...
    protected List<Integer> seatsNumber;
     ...
     * This is why there is not a <CODE>set</CODE> method for the seatsNumber property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSeatsNumber().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<Integer> getSeatsNumber() {
        if (seatsNumber == null) {
            seatsNumber = new ArrayList<Integer>();
        }
