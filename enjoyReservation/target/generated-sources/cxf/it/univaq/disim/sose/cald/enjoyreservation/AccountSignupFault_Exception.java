...
public class AccountSignupFault_Exception extends Exception {
    ...
    public AccountSignupFault_Exception(String message, Throwable cause) {
        super(message, cause);
    }

    public AccountSignupFault_Exception(String message, it.univaq.disim.sose.cald.enjoyreservation.AccountLoginFault accountLoginFault) {
        super(message);
        this.accountLoginFault = accountLoginFault;
    }

    public AccountSignupFault_Exception(String message, it.univaq.disim.sose.cald.enjoyreservation.AccountLoginFault accountLoginFault, Throwable cause) {
        super(message, cause);
        this.accountLoginFault = accountLoginFault;
    }
